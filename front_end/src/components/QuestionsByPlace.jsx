    ...
    return (
        <Box mt={4}>
            {questions.map((question) => (
                <Card key={question.id} sx={{ mb: 2, p: 2, display: "flex", alignItems: "flex-start" }}>
                            ...
                            <CardContent sx={{ p: 0 }}>
                                ...
                                <Box mt={2}>
                                    <Button
                                        ...
                                        sx={{
                                            mr: 2,
                                            display: question.comment_count > 0 ? "inline-flex" : "none"
                                        }}
                                        onClick={() => {
                                            setActiveQuestionId(activeQuestionId === question.id ? null : question.id);
                                            fetchComments(question.id);
                                        }}
                                    >
                                        {activeQuestionId === question.id ? "Скрыть комментарии" : "Показать комментарии"}
                                    </Button>
                                    <Button
                                        variant="text"
                                        color="primary"
