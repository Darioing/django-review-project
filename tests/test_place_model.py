...
def test_valid_name():
    ...
    place = Places.objects.create(name="Кафе", address="ул. Ленина, 1", category_id=None)
...
def test_valid_category():
    ...
    place = Places.objects.create(name="Кафе", address="ул. Ленина, 1", category_id=category)
...
def test_slug_unique():
    ...
    Places.objects.create(name="Кафе", address="ул. Ленина, 1", category_id=None)
    with pytest.raises(IntegrityError):
        Places.objects.create(name="Кафе", address="ул. Пушкина, 2", category_id=None)
