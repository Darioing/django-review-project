...
def test_place_id_filled_correctly(user, place):
    ...
    review = Reviews.objects.create(
        place_id=place, user_id=user, text="Отличное место", price=5, service=4, interior=3)
...
def test_place_id_empty(user):
    ...
    with pytest.raises(IntegrityError):
        Reviews.objects.create(place_id=None, user_id=user,
                               text="Отличное место", price=5, service=4, interior=3)
...
def test_user_id_empty(place):
    ...
    with pytest.raises(IntegrityError):
        Reviews.objects.create(place_id=place, user_id=None,
                               text="Отличное место", price=5, service=4, interior=3)
...
def test_text_exceeds_max_length(user, place):
    ...
    with pytest.raises(ValidationError):
        review = Reviews.objects.create(
            place_id=place, user_id=user, text=long_text, price=5, service=4, interior=3)
        review.full_clean()
...
def test_text_empty(user, place):
    ...
    review = Reviews.objects.create(
        place_id=place, user_id=user, text=None, price=5, service=4, interior=3)
...
def test_price_below_min(user, place):
    ...
    with pytest.raises(ValidationError):
        review = Reviews(place_id=place, user_id=user,
                         text="Отличное место", price=0, service=4, interior=3)
        review.full_clean()
...
def test_price_above_max(user, place):
    ...
    with pytest.raises(ValidationError):
        review = Reviews(place_id=place, user_id=user,
                         text="Отличное место", price=6, service=4, interior=3)
        review.full_clean()
...
def test_service_below_min(user, place):
    ...
    with pytest.raises(ValidationError):
        review = Reviews(place_id=place, user_id=user,
                         text="Отличное место", price=5, service=0, interior=3)
        review.full_clean()
...
def test_service_above_max(user, place):
    ...
    with pytest.raises(ValidationError):
        review = Reviews(place_id=place, user_id=user,
                         text="Отличное место", price=5, service=6, interior=3)
        review.full_clean()
...
def test_interior_below_min(user, place):
    ...
    with pytest.raises(ValidationError):
        review = Reviews(place_id=place, user_id=user,
                         text="Отличное место", price=5, service=4, interior=0)
        review.full_clean()
...
def test_interior_above_max(user, place):
    ...
    with pytest.raises(ValidationError):
        review = Reviews(place_id=place, user_id=user,
                         text="Отличное место", price=5, service=4, interior=6)
        review.full_clean()
